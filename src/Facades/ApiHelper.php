...
namespace Ducal\Api\Facades;

use Ducal\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \Ducal\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \Ducal\Api\Supports\ApiHelper
 */
